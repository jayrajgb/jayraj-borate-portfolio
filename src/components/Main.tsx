  ...
  return (
    <div className="w-full px-4 sm:px-10 md:px-12">
      <main className="px-4 sm:px-6 md:px-8">
        <div
          id="home"
          className="home flex flex-col md:flex-row items-center justify-center pt-20 md:pt-24 min-h-[95vh]"
        >
          <div className="intro flex flex-col justify-center items-center md:items-center w-full md:w-1/2">
            <div className="space-y-1 md:space-y-2 text-center md:text-left">
              <h1 className="bebas text-5xl sm:text-[5rem] leading-none">
                JAYRAJ BORATE
              </h1>
              ...
              <div className="py-1 space-y-1 text-lg md:text-xl">
                <p className="leading-none">
                  Hello there, I&apos;m Jayraj and I am
                </p>
              ...
              <div className="w-full flex justify-center md:justify-start">
                <button>
                  <Link
                    href="/Jayraj_Borate_Resume.pdf"
                    target="_blank"
                    className="cv mt-2 flex items-center gap-x-2 px-4 py-2 text-base"
                  >
          ...
          <div className="hero md:flex justify-center items-center w-full md:w-1/2 hidden">
            ...
            <img
              className="photograph size-[13rem] sm:size-[16rem] md:size-[22rem] lg:size-[30rem] absolute"
        ...
        <div
          id="about"
          className="section min-h-[40vh] pt-24 md:min-h-screen flex flex-col md:flex-row items-center gap-x-8 md:pt-16"
        >
          <div className="section-image hidden md:flex md:justify-center md:items-center md:w-1/2">
            <img
              className="image-style size-[15rem] sm:size-[18rem] md:size-[24rem] lg:size-[32rem] rounded-full"
          ...
          <div className="section-text w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="intro2 text-md md:text-xl mb-6">
              I am Jayraj Borate, an Electronics and Telecommunication
              Engineering student at VIT, Pune, with a strong foundation in Full
              Stack Web Development. I am proficient in skills including
              React.js for building dynamic user interfaces and Node.js for
              backend development. Currently, I am learning Next.js, a
              full-stack framework to enhance performance and streamline
              development process. <br />
              I have a strong passion for UI/UX design and development, and I am
              skilled in crafting interactive prototypes and creating
              user-focused designs. My skills in design tools include Adobe XD
              and Figma, enabling me to bring ideas to life effectively. <br />I
              am dedicated to continuous learning and I strive to deliver
              impactful, user-centric solutions by combining technical expertise
              with a creative approach.
            </p>
            <button>
              <Link
                href="/#footer"
                className="contact px-4 py-2 text-sm sm:text-base"
              >
                Contact me
              </Link>
            </button>
        ...
        <div id="skills" className="skills pt-24">
          <h1 className="header text-5xl sm:text-[5rem] font-bold text-center sm:text-left mb-8">
            Skills
          </h1>
            ...
            <div className="skill-item flex justify-between items-center p-4 rounded-lg">
              ...
              <div className="w-1/2 justify-center skill-right flex gap-1">
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="dots w-3 h-3 sm:w-4 sm:h-4 rounded-full"
                  ></div>
                ))}
                {[...Array(1)].map((_, i) => (
                  <div
                    key={i}
                    className="dot2 w-3 h-3 sm:w-4 sm:h-4 rounded-full"
                  ></div>
                ))}
              </div>
            </div>
            ...
            <div className="skill-item flex justify-between items-center p-4 rounded-lg">
              <div className="w-1/2 skill-left flex items-center gap-3">
                <img
                  src="/assets/java.svg"
                  alt="java"
                  className="w-6 h-6 sm:w8 sm:h-8"
                />
        ...
        <div id="projects" className="projects pt-24">
          <h1 className="header text-5xl sm:text-[5rem] font-bold text-center sm:text-left mb-16 md:mb-8">
            Projects
          </h1>
          <div className="project-container flex flex-col gap-12">
            ...
            <div className="project-item flex flex-col md:flex-row md:justify-evenly items-start md:items-center">
              ...
              <img
                src="/assets/project11.png"
                alt="project11"
                className="w-full md:w-3/5 rounded-lg shadow-lg mt-6 mb-10"
              />
            </div>
